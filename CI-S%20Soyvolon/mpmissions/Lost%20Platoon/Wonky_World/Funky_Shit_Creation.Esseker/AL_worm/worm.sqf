...
_cap	= createVehicle ["Land_CanOpener_F",getPos _poz_worm,[],0,"CAN_COLLIDE"];
_coada	= createVehicle ["Land_CanOpener_F",getPos _poz_worm,[],0,"CAN_COLLIDE"];
_coada_01= createVehicle ["Land_CanOpener_F",getPos _poz_worm,[],0,"CAN_COLLIDE"];
