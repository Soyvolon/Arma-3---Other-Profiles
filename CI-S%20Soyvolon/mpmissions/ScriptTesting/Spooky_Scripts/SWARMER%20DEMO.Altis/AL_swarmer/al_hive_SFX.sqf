...
while {alive _stup} do
{
	...
	_roi_SFX setParticleParams [["\A3\animals_f\fly.p3d",1,0,1,1],"","SpaceObject",1,_life_fct,[0,0,0],[_flow_self # 0,_flow_self # 1,0],0,10,7.9,0,[6],[[1,1,1,1]],[1],1,1,"","AL_swarmer\al_flies.sqf",_stup,0];
