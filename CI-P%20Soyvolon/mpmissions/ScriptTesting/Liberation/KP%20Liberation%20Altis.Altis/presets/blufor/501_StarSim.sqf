...
KP_liberation_little_bird_classname = "RD501_LAAT_Mk2";                   // These are the LAATs which spawn on the Freedom or at Chimera base.
KP_liberation_boat_classname = "RD501_speedboat_republic";                // These are the boats which spawn at the stern of the Freedom.
KP_liberation_truck_classname = "RD501_fast_infantry_transport_republic"; // These are the trucks which are used in the logistic convoy system.
