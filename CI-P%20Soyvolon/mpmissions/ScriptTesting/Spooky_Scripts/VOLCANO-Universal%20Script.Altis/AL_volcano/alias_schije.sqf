...
if (selectrandom [true,false]) then {
			...
			_bolovani setParticleParams [["\A3\data_f\ParticleEffects\Universal\Mud.p3d",1,0,1],"","SpaceObject",0.05,7,[0,0,0],[0,0,150],1,1000,5,0,[8,8,.1],[[0,0,0,1],[0,0,0,1],[0.5,0.5,0.5,1]],[0.125],1,0,"AL_volcano\rock_trail.sqf","", _alias_volcano]
		} else {
