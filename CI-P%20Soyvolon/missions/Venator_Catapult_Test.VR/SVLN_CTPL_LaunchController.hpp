...
class SVLN_CTPL_LaunchController
{
	...
	class Controls
	{
		...
		class SVLN_CTRL_Launch
		{
			...
			soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape",0.09,1.0};
			soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush",0.09,1.0};
			onButtonClick = "if (!isNil 'global_catapults') then {     _index = lbCurSel 1515;     _cat = (global_catapults getOrDefault ['catapults', []]) select _index;    [_cat select 0, parseNumber ctrlText 1512, parseNumber ctrlText 1501, parseNumber ctrlText 1502, parseNumber ctrlText 1503, parseNumber ctrlText 1511, parseNumber ctrlText 1504] spawn { _this call SVLN_fnc_launchCatapult };    closeDialog 1;};";
		...
		class SVLN_CTRL_Cancel_copy1
		{
			...
			soundEscape[] = {"\A3\ui_f\data\sound\RscButton\soundEscape",0.09,1.0};
			soundPush[] = {"\A3\ui_f\data\sound\RscButton\soundPush",0.09,1.0};
			onButtonClick = "lbClear 1515; if (!isNil 'global_catapults') then { { lbAdd [1515, (_x select 1)]; } forEach (global_catapults getOrDefault ['catapults', []]); };";
			onMouseButtonClick = "";
